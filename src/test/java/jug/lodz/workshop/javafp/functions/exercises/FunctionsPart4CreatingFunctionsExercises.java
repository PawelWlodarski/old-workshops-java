 ...
 */
public class FunctionsPart4CreatingFunctionsExercises {
    @Test
    ...
    public void testNetToGross() throws Exception {
        Function<Double,Function<Integer,Double>> gross= null;
    ...
    public void testGreaterThanCurrying() throws Exception {
        Function<Integer,Predicate<Integer>> greaterThanCurrying=null;
    ...
    private <A,B,C> Function<A,Function<B,C>> curry(BiFunction<A,B,C> f){return null;}
    ...
    private <A,B,C> BiFunction<A,B,C>  unCurry(Function<A,Function<B,C>> f){return null;}
