 ...
 */
public class FunctionsPart5Effects implements Printer{

    private static FunctionsPart5Effects lab=new FunctionsPart5Effects();
    ...
    private void demo(){
        ...
        println(" * CONCEPT OF A PARTIAL FUNCTION");
