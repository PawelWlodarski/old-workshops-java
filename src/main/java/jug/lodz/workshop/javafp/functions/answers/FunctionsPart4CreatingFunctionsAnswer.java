 ...
 */
public class FunctionsPart4CreatingFunctionsAnswer implements Printer{

    private static FunctionsPart4CreatingFunctionsAnswer lab=new FunctionsPart4CreatingFunctionsAnswer();
