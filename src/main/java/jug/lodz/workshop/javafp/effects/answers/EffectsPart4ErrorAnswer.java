 ...
 */
public class EffectsPart4ErrorAnswer {
    ...
    static void exerciseLevel3() {
        ...
        Function<Customer, Option<BigDecimal>> applyDiscount = c -> readDiscount.apply(c)
                .map(happyPath.apply(new BigDecimal("100")))
