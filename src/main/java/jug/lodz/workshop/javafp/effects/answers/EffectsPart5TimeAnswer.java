 ...
 */
public class EffectsPart5TimeAnswer {
...
//        print("  * this will never happen: "+result2);
    ...
    static void exerciseLevel1() {
        ...
        Try<BigDecimal> discount = Try.of(
                () -> discountForUser.apply(data().joe)
                        .thenCombine(discountOfTheDay.get(), BigDecimal::add)
    ...
    static void exerciseLevel2() {
        ...
        //EXERCISE
        BiFunction<Integer, Throwable, Try<Integer>> handleFuture = (value, error) ->
                error == null ? Try.success(value) : Try.failure(error);
