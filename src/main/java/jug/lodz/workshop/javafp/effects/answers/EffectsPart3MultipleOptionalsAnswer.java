 ...
 */
public class EffectsPart3MultipleOptionalsAnswer {
    ...
    static void exerciseLevel1() {
        ...
        Optional<BigDecimal> discountForJoe = findInMap(searchId, "Joe").flatMap(id -> findInMap(discountForUser, id));
        Optional<BigDecimal> discountForJane = findInMap(searchId, "Jane").flatMap(id -> findInMap(discountForUser, id));
    ...
    static void exerciseLevel2() {
        ...
        Function<Consultant, Optional<String>> getContactInfo = c ->
                Option.of(c.email)
                        .orElse(Option.of(c.phoneNumber))
                        .toJavaOptional();
    ...
    static void exerciseLevel3() {
        ...
        Function<Purchase, String> consultantInfo = p -> API.For(Option.of(p.consultant), (Consultant c) ->
                For(Option.of(c.email).orElse(Option.of(c.phoneNumber)))
                        .yield(info -> "You can contact our consultant : " + info)
